...
| # | סצנה | טווח זמן | תיאור | טכניקת אנימציה |
|---|---|---|---|---|
| 1 | פתיח | 0–15 שנ' | עומס יומיומי: שעון מעורר, התראות, דופק חזותי | Scale-up, fade-in, spring |
| 2 | הבעיה | 15–35 שנ' | יום עמוס: לוח שנה צפוף, כרטיסי משימות | Staggered entrance, parallax |
| 3 | הפתרון | 35–60 שנ' | ממשק TimeUp נקי, checkmarks, reveal לוגו, CTA | Crossfade, glow reveal |
